...
class User(AbstractUser):
    ...
    username = models.CharField(
        ...
        }, default=generate_alphanum_crypt_string(16)
    )
    ...
    type = models.CharField(verbose_name='Тип пользователя', choices=USER_TYPE_CHOICES.choices, max_length=23,
                            default='buyer')
...
class Order(models.Model):
    ...
    state = models.CharField(verbose_name='Статус', choices=STATE_CHOICES.choices, max_length=28)
